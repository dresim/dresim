...
function updateToolTip(chosenXAxis, chosenYAxis, circlesGroup) {
  ...
  /*
  if (chosenYAxis === "all") {
    var label2 = "Node Numbers:";
  } else if (chosenYAxis === "metro") {
    var label2 = "Success rate:";
  } else {
    var label2 = "Maintinance rate:";
  }*/
  var label2 = "Node #:";
...
var inputfile = "assets/data/pre.csv";
d3.csv(inputfile).then(function(healthData) {
...
*/
  ...
  var metroLabel = labelsGroup1
    .append("text")
    .attr("transform", "rotate(-90)")
    .attr("y", -70)
    .attr("x", 0 - height / 2)
    .attr("value", "metro") // value to grab for event listener
    .text("Metro")
    .classed("inactive", true);

  var powerLabel = labelsGroup1
    .append("text")
    .attr("transform", "rotate(-90)")
    .attr("y", -90)
    .attr("x", 0 - height / 2)
  ...
  labelsGroup1.selectAll("text").on("click", function() {
    ...
    if (value !== chosenYAxis) {
      ...
      if (chosenYAxis === "metro") {
        metroLabel.classed("active", true).classed("inactive", false);
        allLabel.classed("active", false).classed("inactive", true);
        powerLabel.classed("active", false).classed("inactive", true);
      } else if (chosenYAxis === "power") {
        metroLabel.classed("active", false).classed("inactive", true);
        allLabel.classed("active", false).classed("inactive", true);
        powerLabel.classed("active", true).classed("inactive", false);
      } else {
        metroLabel.classed("active", false).classed("inactive", true);
        allLabel.classed("active", true).classed("inactive", false);
        powerLabel.classed("active", false).classed("inactive", true);
      }
    }
  });
  ...
  labelsGroup.selectAll("text").on("click", function() {
    ...
    if (value !== chosenXAxis) {
      ...
      if (chosenXAxis === "age") {
        ...
        //updatedata("assets/data/pre.csv");
      } else if (chosenXAxis === "income") {
        ...
        //incomeLabel.classed("active", false).classed("inactive", true);
        //updatedata("assets/data/post.csv");
      }
    }
  });
});
